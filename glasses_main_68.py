...
faces_folder = os.path.expanduser("/Users/Brett/Desktop/Biometrics_Project/FaceDisguiseDatabase/FaceAll_cropped")
...
def get_landmarks(images, labels, save_directory="landmarks_folder", num_coords=68, to_save=True):
    ...
    new_labels = []
    img_ct = 0
    predictor_path = '/Users/Brett/Desktop/Biometrics_Project/Loading Images and Extracting Landmarks/shape_predictor_68_face_landmarks.dat'
...
ground_truth_folder = '/Users/Brett/Desktop/Biometrics_Project/FaceDisguiseDatabase/Ground_Truth'
...
matching_scores = pd.DataFrame(svc_scores, columns=classes)
print("matched scores")

knn_test_predictions = clf.predict(X_glasses)  
svc_test_predictions = clf2.predict(X_glasses)
knn_test_accuracy = accuracy_score(y_glasses, knn_test_predictions)
svc_test_accuracy = accuracy_score(y_glasses, svc_test_predictions)
